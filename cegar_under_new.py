...
class Z3Model:
    ...
    def run(self):
        ...
        init_obs = 1  # initial the number of observable events.
        ...
        # print("self.invTransition[i]",self.invTransition)
        # print("self.BOUND",self.BOUND)
        # print("self.cptFaultOccursByThePast[i]",self.cptFaultOccursByThePast)
        # print("self.NO_OBS",self.NO_OBS)
        # print("self.flag",self.flag)
        # print("self.checkSynchro[i]",self.checkSynchro)
        # print("self.idTransitionFaultyPath",self.idTransitionFaultyPath)
        # print("self.globalClockFaultyPath",self.globalClockFaultyPath)
        # exit(0)
